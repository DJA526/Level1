...
public class SimonSays extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
  	images.put(new Integer(KeyEvent.VK_UP), "http://www.mnhuntingcalendar.com/wp-content/uploads/2016/02/the-letter-a-pala.jpg");
  	images.put(new Integer(KeyEvent.VK_UP), "http://cdn3.volusion.com/swkxh.awrcc/v/vspfiles/photos/ught-iron-house-letter-k-LET-K-2.jpg?1447069989");
  	images.put(new Integer(KeyEvent.VK_UP), "http://pre11.deviantart.net/89dc/th/pre/f/2015/339/f/5/letter_d_by_hillygon-d9j3muk.jpg");
